...
paths.dofile('Bottleneck.lua')
paths.dofile('Bottleneck2Rooms.lua')
paths.dofile('MovingGoalsEasy.lua')
paths.dofile('MovingGoalsMedium.lua')
paths.dofile('MovingGoalsHard.lua')
paths.dofile('MovingGoalsEasyMod.lua')
paths.dofile('MovingGoalsMediumMod.lua')
...
local function init_game_opts()
    ...
    games.Bottleneck = Bottleneck
    helpers.Bottleneck = OptsHelper
    games.Bottleneck2Rooms = Bottleneck2Rooms
    helpers.Bottleneck2Rooms = OptsHelper
    games.MovingGoalsEasy = MovingGoalsEasy
    helpers.MovingGoalsEasy = OptsHelper
    games.MovingGoalsMedium = MovingGoalsMedium
    helpers.MovingGoalsMedium = OptsHelper
    games.MovingGoalsHard = MovingGoalsHard
    helpers.MovingGoalsHard = OptsHelper
    games.MovingGoalsEasyMod = MovingGoalsEasyMod
    helpers.MovingGoalsEasyMod = OptsHelper
    games.MovingGoalsMediumMod = MovingGoalsMediumMod
    helpers.MovingGoalsMediumMod = OptsHelper
