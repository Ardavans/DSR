local MovingGoalsMediumMod, parent = torch.class('MovingGoalsMediumMod', 'MazeBase')

math = require ('math')

function MovingGoalsMediumMod:__init(opts, vocab)
    opts.height = 7
    opts.width = 7
...
function MovingGoalsMediumMod:update()
    parent.update(self)
...
function MovingGoalsMediumMod:get_reward()
